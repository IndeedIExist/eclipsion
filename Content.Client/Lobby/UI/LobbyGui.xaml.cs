...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class LobbyGui : UIScreen
    {
        ...
        public LobbyGui()
        {
            ...
            SetAnchorPreset(AnimatedBg, LayoutPreset.Wide);
            AnimatedBg.DisplayRect.Stretch = TextureRect.StretchMode.KeepAspectCovered;
            AnimatedBg.DisplayRect.HorizontalExpand = true;
            AnimatedBg.DisplayRect.VerticalExpand = true;
