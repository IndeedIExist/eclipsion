...
ent-TAPOverwatchClipboard = Squad Overwatch Tablet «ECHO»
    .desc = { ent-BaseOverwatchClipboard.desc }
ent-IPMOverwatchClipboard = Squad Overwatch Tablet «DARK WEB»
    .desc = { ent-BaseOverwatchClipboard.desc }
ent-SAWOverwatchClipboard = Squad Overwatch Tablet «DARK WEB»
    .desc = { ent-BaseOverwatchClipboard.desc }
ent-GSCOverwatchClipboard = Squad Overwatch Tablet «DARK WEB»
    .desc = { ent-BaseOverwatchClipboard.desc }
ent-CDOverwatchClipboard = Squad Overwatch Tablet «DARK WEB»
    .desc = { ent-BaseOverwatchClipboard.desc }
