    ...
    public abstract partial class ExamineSystemShared : EntitySystem
    {
        ...
        public void AddDetailedExamineVerb(GetVerbsEvent<ExamineVerb> verbsEvent, Component component, List<ExamineEntry> entries, string verbText, string iconTexture = DefaultIconTexture, string hoverMessage = "")
        {
            AddDetailedExamineVerb(verbsEvent, component, entries, verbText,
                new SpriteSpecifier.Texture(new ResPath(iconTexture)), hoverMessage);
        }

        /// <summary>
        ///     Either sends the details to a GroupExamineComponent if it finds one, or adds a details examine verb itself.
        /// </summary>
        public void AddDetailedExamineVerb(GetVerbsEvent<ExamineVerb> verbsEvent, Component component, List<ExamineEntry> entries, string verbText, SpriteSpecifier icon, string hoverMessage = "")
        {
        ...
        ///     Either adds a details examine verb, or sends the details to a GroupExamineComponent if it finds one.
        /// </summary>
        public void AddDetailedExamineVerb(GetVerbsEvent<ExamineVerb> verbsEvent, Component component, ExamineEntry entry, string verbText, SpriteSpecifier icon, string hoverMessage = "")
        {
            AddDetailedExamineVerb(verbsEvent, component, new List<ExamineEntry> { entry }, verbText, icon, hoverMessage);
        }
        ...
        ///     Either adds a details examine verb, or sends the details to a GroupExamineComponent if it finds one.
        /// </summary>
        public void AddDetailedExamineVerb(GetVerbsEvent<ExamineVerb> verbsEvent, Component component, FormattedMessage message, string verbText, SpriteSpecifier icon, string hoverMessage = "")
        {
            var componentName = _componentFactory.GetComponentName(component.GetType());
            AddDetailedExamineVerb(verbsEvent, component, new ExamineEntry(componentName, 0f, message), verbText, icon, hoverMessage);
        }
    }
}
